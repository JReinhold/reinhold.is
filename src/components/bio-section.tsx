...
export const BioSection: React.SFC = () => (
	<section className={section}>
		...
		<div className={twoColumn}>
			<p>
				For as long as I can remember, I've loved working with computers. When I
				was 11 years old I wanted to learn programming, so I grabbed my sister's
				university-level C++ book and started coding. As I reached the concept
				of <em>classes</em>, I thought to myself:
			</p>
			<blockquote>
			...
			<p>
				...
				<em>was</em> smart enough, C++ just wasn't the best language to learn as
				a 11 year old newbie. 🤷‍♂️
			</p>
			<p>
				I also realised that there was something called{' '}
				<em>Interaction Design/UX/Product Design</em>, and that I'd always had a
				passion for it, I just didn't knew it was a thing. I always thought the
				voice in my head that was annoyed by the world, when in fact all it did
				was keep pointing out all the mistakes designers had made in the
			...
			<p>
				...
				my surroundings. I love the beauty of nature, and I want to spend all my
				energy and skill on making sure we preserve that beauty for future
				generations.
			</p>
			<p>
